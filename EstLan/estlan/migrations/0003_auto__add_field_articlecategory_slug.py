...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleCategory.slug'
        db.add_column(u'estlan_articlecategory', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ArticleCategory.parent'
        db.add_column(u'estlan_articlecategory', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['estlan.ArticleCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleCategory.slug'
        db.delete_column(u'estlan_articlecategory', 'slug')

        # Deleting field 'ArticleCategory.parent'
        db.delete_column(u'estlan_articlecategory', 'parent_id')
