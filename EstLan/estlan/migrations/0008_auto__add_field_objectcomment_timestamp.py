...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ObjectComment.timestamp'
        db.add_column(u'estlan_objectcomment', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.utcnow),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ObjectComment.timestamp'
        db.delete_column(u'estlan_objectcomment', 'timestamp')
