...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'estlan_objectcomment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['account.User'])),
        ...
        db.create_table(u'estlan_article', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['account.User'])),
    ...
    models = {
        ...
        u'estlan.article': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['account.User']"}),
        ...
        u'estlan.objectcomment': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['account.User']"})
        }
    }
